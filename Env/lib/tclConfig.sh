...
# installed.
TCL_PREFIX='/home/leo/PycharmProjects/SmartLockServer/Env'

# Top-level directory in which Tcl's platform-specific files (e.g.
# executables) are installed.
TCL_EXEC_PREFIX='/home/leo/PycharmProjects/SmartLockServer/Env'
...
TCL_EXTRA_CFLAGS='-march=nocona -mtune=haswell -ftree-vectorize -fPIC -fstack-protector-strong -fno-plt -O2 -pipe -I/home/leo/PycharmProjects/SmartLockServer/Env/include -fdebug-prefix-map=${SRC_DIR}=/usr/local/src/conda/${PKG_NAME}-${PKG_VERSION} -fdebug-prefix-map=${PREFIX}=/usr/local/src/conda-prefix -pipe -m64 -DNDEBUG -D_FORTIFY_SOURCE=2 -O2'
...
TCL_LD_FLAGS='-Wl,-O2 -Wl,--sort-common -Wl,--as-needed -Wl,-z,relro -Wl,-z,now -Wl,--disable-new-dtags -Wl,-rpath,/home/leo/PycharmProjects/SmartLockServer/Env/lib -L/home/leo/PycharmProjects/SmartLockServer/Env/lib -Wl,--export-dynamic '
...
# String to pass to linker to pick up the Tcl library from its
# installed directory.
TCL_LIB_SPEC='-L/home/leo/PycharmProjects/SmartLockServer/Env/lib -ltcl8.6'

# String to pass to the compiler so that an extension can
# find installed Tcl headers.
TCL_INCLUDE_SPEC='-I/home/leo/PycharmProjects/SmartLockServer/Env/include'
...
TCL_PACKAGE_PATH='/home/leo/PycharmProjects/SmartLockServer/Env/lib '
...
# String to pass to linker to pick up the Tcl stub library from its
# installed directory.
TCL_STUB_LIB_SPEC='-L/home/leo/PycharmProjects/SmartLockServer/Env/lib -ltclstub8.6'

# Path to the Tcl stub library in the build directory.
TCL_BUILD_STUB_LIB_PATH='/tmp/build/80754af9/tk_1535485056075/work/tcl8.6.8/unix/libtclstub8.6.a'

# Path to the Tcl stub library in the install directory.
TCL_STUB_LIB_PATH='/home/leo/PycharmProjects/SmartLockServer/Env/lib/libtclstub8.6.a'
